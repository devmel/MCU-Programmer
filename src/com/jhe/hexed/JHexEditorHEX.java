...
{
	private static final long serialVersionUID = -396494120777241764L;
    ...
    public void paint(Graphics g)
    {
        ...
        for(int n=ini;n<fin;n++)
        {
            ...
            String s=("0"+Integer.toHexString(he.buffer[n+he.bufferOffset]).toUpperCase());
    ...
    public void keyTyped(KeyEvent e)
    {
    	...
    	if(he.bufferLocked==false){
	        ...
	        {
	            char[] str=new char[2];
	            String n="00"+Integer.toHexString((int)he.buffer[he.cursor+he.bufferOffset]);
	            if(n.length()>2) n=n.substring(n.length()-2);
	            str[1-cursor]=n.charAt(1-cursor);
	            str[cursor]=e.getKeyChar();
	            he.buffer[he.cursor+he.bufferOffset] = (byte)Integer.parseInt(new String(str),16);
	            if(cursor!=1) cursor=1;
	            else if(he.cursor!=(he.bufferSize-1)){ he.cursor++; cursor=0;}
	            he.actualizaCursor();
